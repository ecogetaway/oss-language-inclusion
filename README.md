...
- **Scope.** The case studies so far are Hindi pull requests, because Hindi is the language the researcher can verify first-hand — and because Indian languages barely register in the ICSE 2026 study's data (eight were measured; together about 0.03% of the non-English messages counted, by our tally of the study's published data). The gap itself is not specific to any language: it appears wherever maintainers cannot read what they are asked to approve. The method and tools are language-neutral, and evidence from other languages is welcome.
---
