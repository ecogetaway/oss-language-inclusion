...
- **Scope.** The case studies so far are Hindi pull requests, because Hindi is the language the researcher can verify first-hand — and Indian languages are among those the ICSE 2026 study did not measure. The gap itself is not specific to any language: it appears wherever maintainers cannot read what they are asked to approve. The method and tools are language-neutral, and evidence from other languages is welcome.
---
