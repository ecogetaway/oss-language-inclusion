...
## Where to post (quick guide)

- **Raw maintainer experience** (i18n load, review policy, tools): open a [GitHub issue](https://github.com/ecogetaway/oss-language-inclusion/issues/new/choose) and select **Maintainer feedback (raw input)**. Prefer **public links** to upstream issues, PRs, or docs. Use the [maintainer format](maintainer-feedback/README.md) in the body.
...
Typo and small doc fixes: PRs are fine. For larger structural or narrative changes, open an issue first so reviewers can see intent in one place.
